...
//Mutates the plant overall (randomly). Now with mutation controll, generating a list of valid numbers to roll
//Changing the third parameter from mutation_level to the tray itself and generating mutation_level off of it, needed it to access
/datum/seed/proc/mutate(degree, turf/source_turf, mutation_level, list/mutation_controller)
	...
	for(var/c=1; c<length(mutation_controller); c++)
		...
		//Mutation enablers, values >0 set just those
		if(mutation_controller[mut_name] > 0)
			allowed_mutations += list(c)
			mutation_enable_check = TRUE
		//level 1 mutation cancellers can still be rolled, blocking mutation but wasting it as well, stored as negative
	...
	for(var/i in 0 to total_mutations+max(0, round(mutation_level/50)))
		...
		//Low level mutation stored as negative value cancels any mutation
		if(mut_number < 1)
			return
...
/datum/seed/berry/glow
	...
	chems = list("fruit" = list(1,10), "uranium" = list(3,5))
...
/datum/seed/tomato/blood
	...
	chems = list("vegetable" = list(1,10), "blood" = list(1,5))
...
/datum/seed/tomato/blue
	...
	chems = list("vegetable" = list(1,20))
...
/datum/seed/tomato/blue/teleport
	...
	chems = list("vegetable" = list(1,20), "singulo" = list(1,5))
...
/datum/seed/apple/gold
	...
	chems = list("fruit" = list(1,10), "gold" = list(1,5))
...
/datum/seed/ambrosia
	...
	harvest_repeat = 1
	chems = list("plantmatter" = list(1), "space_drugs" = list(1,8), "kelotane" = list(1,8,1), "bicaridine" = list(1,10,1), "toxin" = list(1,10))
...
/datum/seed/mushroom/hallucinogenic/strong
	...
	plant_icon = "liberty"
	chems = list("mushroom" = list(1), "stoxin" = list(3,3), "space_drugs" = list(1,25))
...
/datum/seed/mushroom/poison
	...
	plant_icon = "amanita"
	chems = list("mushroom" = list(1), "amatoxin" = list(3,3), "psilocybin" = list(1,25))
...
/datum/seed/mushroom/poison/death
	...
	plant_icon = "angel"
	chems = list("mushroom" = list(1,50), "amatoxin" = list(13,3), "psilocybin" = list(1,25))
...
/datum/seed/grapes
	...
	plant_icon = "grape"
	harvest_repeat = 1
	chems = list("fruit" = list(1,10), "sugar" = list(1,5))
...
/datum/seed/grapes/green
	...
	chems = list("fruit" = list(1,10), "kelotane" = list(3,5))
...
/datum/seed/whitebeets
	...
	chems = list("vegetable" = list(0,20), "sugar" = list(1,5))
